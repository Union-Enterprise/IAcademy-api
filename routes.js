...
const { login, register, del, updateName, updateEmail, updatePassword, updateCPF, updateIMG, getUser, exit, getPasswordHash, comparePassword, updatePasswordAccess } = require('./src/controllers/account')
